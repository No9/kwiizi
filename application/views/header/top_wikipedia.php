		    ...
		    <div class="row-fluid">
                <div class="span3"> 
					...
					<div class="input-append show_me_search" style="padding-top:10px;display:none;">
					   <input class="input watermark_search wiper" type="text" placeholder="<?php echo $this->lang->line('form_search'); ?>"><button class="btn btn-primary watermark_search_valid" type="button"><i class="icon-search icon-white"> </i></button>
				    </div>				
				</div>
